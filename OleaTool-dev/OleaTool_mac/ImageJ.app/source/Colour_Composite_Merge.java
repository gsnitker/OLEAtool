...
public class Colour_Composite_Merge implements PlugIn {
	int nCh=4;
	...
	public void run(String arg) {
		...
		GenericDialog gd = new GenericDialog("Colour Composite Merge");
		
		gd.addChoice("Red_Stack:", titles, titles[0]);
		String title2 = titles.length>2?titles[1]:none;
		gd.addChoice("Green_Stack:", titles, title2);
		String title3 = titles.length>3?titles[2]:none;
		gd.addChoice("Blue_Stack:", titles, title3);
		String title4 = titles.length>4?titles[3]:none;
		gd.addChoice("Grey_Stack:", titles, title4);
