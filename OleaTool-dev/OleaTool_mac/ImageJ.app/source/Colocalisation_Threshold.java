...
//	gd.addChoice("Mask_channel", chooseMask, chooseMask[indexMask]);
	gd.addChoice("Channel_Combination", dualChannels, dualChannels[dualChannelIndex]);
	gd.addCheckbox("Show_Colocalised pixels",bShowLocalisation);
	gd.addCheckbox("Use_constant intensity for colocalised pixels",colocValConst);
	gd.addCheckbox("Show_Scatter plot",bScatter);
	gd.addCheckbox("Include_zero-zero pixels in threshold calculation",opt0);
	
	gd.addCheckbox("Set_options",false);
...
if (dualChannelIndex==2) 
	...
	if (options)
		...
		gd2.addCheckbox("Show_linear regression solution",opt1a);
		gd2.addCheckbox("Show_thresholds",opt1);
		gd2.addCheckbox("Pearson's_for_whole_image",opt2);
		gd2.addCheckbox("Pearson's_for_image_above thresholds",opt3a);
		gd2.addCheckbox("Pearson's_for_image_below thresholds (should be ~0)",opt3b);
		gd2.addCheckbox("Mander's_original coefficients (threshold = 0)",opt4);
		gd2.addCheckbox("Mander's_using_thresholds",opt5);
		gd2.addCheckbox("Number_of_colocalised voxels",opt6);
		gd2.addCheckbox("%_Image_volume colocalised",opt7);
		gd2.addCheckbox("%_Voxels colocalised",opt8);
		gd2.addCheckbox("%_Intensity_colocalised",opt9);
		gd2.addCheckbox("%_Intensity_above_threshold colocalised",opt10);
		gd2.showDialog();
