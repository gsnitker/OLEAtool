...
//get profile1
		...
		float  frameInterval = (float)0.187;
			// (float) 12/imp.getStackSize();
		
		//IJ.log(""+frameInterval);
...
//fit curve
		...
		double[] initialParams = new double [3];
;

		initialParams[0]=0.1;
		initialParams[1]=0.01;
		initialParams[2]=10;

		cf.setInitialParameters(initialParams);
