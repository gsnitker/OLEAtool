...
public class Colour_ProfilePlot {
    ...
    public Colour_ProfilePlot() {
    }

    public Colour_ProfilePlot(ImagePlus imp) {
        this(imp, false);
    }

    public Colour_ProfilePlot(ImagePlus imp, boolean averageHorizontally) {
        this.imp = imp;
        Roi roi = imp.getRoi();
        if (roi==null) {
    ...
    public static void setMinAndMax(double min, double max) {
        fixedMin = min;
        fixedMax = max;
        IJ.register(Colour_ProfilePlot.class);
    }
