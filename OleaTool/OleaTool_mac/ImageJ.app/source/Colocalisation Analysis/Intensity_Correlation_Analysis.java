...
public boolean showDialog()
{
	...
	gd.addCheckbox("Use fixed means", false);
	gd.addNumericField("Fixed ch1 mean", 0,0);
	gd.addNumericField("Fixed ch2 mean", 0,0);
	...
	boolean fixedmeans=gd.getNextBoolean();
	double ch1fixmean = gd.getNextNumber();
	double ch2fixmean = gd.getNextNumber();
...
boolean include = false;
	...
	IJ.log("Mean Ch1="+meanCh1+"Mean Ch2="+meanCh2+);
